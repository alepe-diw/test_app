...
# loading libraries -------------------------------------------------------
webr::install(c(
  "shiny","shinyBS","ggplot2","dplyr",
  "readr","data.table","scales", "MicSim"
))
...
run_sim <- function(time_sick_days = 14,
  ...
  inc_dat_m <- read_csv(
    url("https://raw.githubusercontent.com/bieneSchwarze/ProjectionPandemicIncidence/refs/heads/main/data/SurvStat_male_data.csv"),
    show_col_types = FALSE
  )
  inc_dat_f <- read_csv(
    url("https://raw.githubusercontent.com/bieneSchwarze/ProjectionPandemicIncidence/refs/heads/main/data/SurvStat_female_data.csv"),
    show_col_types = FALSE
  )
